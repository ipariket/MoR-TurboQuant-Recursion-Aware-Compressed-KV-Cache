...
class MoRConfig:
    ...
    kv_bits: int = 3  # 0 = no compression, 3 or 4 = TurboQuant-style
    kv_group_size: int = 128  # compression group size (matches head_dim typically)
    ...
    def validate(self):
        ...
        assert self.kv_bits in (0, 3, 4), "kv_bits must be 0 (none), 3, or 4"
